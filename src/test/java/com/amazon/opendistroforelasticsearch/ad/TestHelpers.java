...
public class TestHelpers {
    ...
    public static DetectorInternalState randomDetectState(long rcfUpdates) {
        return randomDetectState(rcfUpdates, randomAlphaOfLength(5), Instant.now());
    }

    public static DetectorInternalState randomDetectState(String error) {
        return randomDetectState(randomLong(), error, Instant.now());
    }

    public static DetectorInternalState randomDetectState(Instant lastUpdateTime) {
        return randomDetectState(randomLong(), randomAlphaOfLength(5), lastUpdateTime);
    }

    public static DetectorInternalState randomDetectState(long rcfUpdates, String error, Instant lastUpdateTime) {
