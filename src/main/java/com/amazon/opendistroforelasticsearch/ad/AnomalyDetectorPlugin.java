...
public class AnomalyDetectorPlugin extends Plugin implements ActionPlugin, ScriptPlugin, JobSchedulerExtension, SystemIndexPlugin {
    ...
    public List<RestHandler> getRestHandlers(
        ...
        jobRunner.setDetectorInfoHandler(detectorInfoHandler);
    ...
    public Collection<Object> createComponents(
        ...
        this.detectorInfoHandler = new DetectorInfoHandler(
            client,
            settings,
            threadPool,
            ...
            .unmodifiableList(
                Arrays
                    .asList(
                        ...
                        new SystemIndexDescriptor(DetectorInfo.ANOMALY_INFO_INDEX, "detector information like total rcf updates")
                    )
            );
    }
}
